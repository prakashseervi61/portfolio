          ...
          <div className="md:col-span-7">
            <div className="text-lg text-muted-foreground max-w-[450px]">
              <p className="slide-up-and-fade">
                ...
                clean, responsive, and reliable web applications.
                I enjoy turning complex problems into simple,
                maintainable solutions.
              </p>
              <p className="mt-3 slide-up-and-fade">
                My approach focuses on creating scalable
                solutions with strong attention to detail and a
                commitment to writing readable code. I
                specialize in React, Tailwind CSS, and modern
                frontend tools.
              </p>
            </div>
          </div>
