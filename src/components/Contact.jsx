    ...
    <section id="contact" className="scroll-mt-24 relative overflow-hidden w-full py-16 sm:py-20 bg-[#fffaf3] bg-[linear-gradient(to_right,rgba(0,0,0,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(0,0,0,0.04)_1px,transparent_1px)] bg-[size:40px_40px]">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-white/80 border border-black/5 rounded-3xl p-8 shadow-lg h-full flex flex-col
          ...
          <div className="bg-white/80 border border-black/5 rounded-3xl p-8 shadow-lg
                          transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button type="submit" disabled={loading} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 rounded-full font-semibold text-white bg-gradient-to-br from-[#ff9f45] to-[#d35400] shadow-[0_10px_25px_rgba(211,84,0,0.3)] transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
